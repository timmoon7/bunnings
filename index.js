...
const addProductsIntoMergedCatalog = (uniqueProductsB) => {
...
const checkBarcodeInBarcodeA = (theBarcode) => {
...
const getAllBarcodesB = (item) => {
  ...
  try {
    barcodes.forEach((barcode) => {
      const result = checkBarcodeInBarcodeA(barcode.Barcode);
...
const addUniqueProductsBIntoMergedCatalog = () => {
  ...
  const transforemdUniqueProductsB =
    addProductsIntoMergedCatalog(uniqueProductsB);
